...
import { AFF_DISCLOSURE } from './config.js';
...
function render() {
  ...
  body.innerHTML =
    ...
    + secHTML(L.siPrivacyH, L.siPrivacy.concat([
        // 追蹤參數的有無決定這一句，而那件事只有一個來源（AFF_IDS）。
        AFF_DISCLOSURE ? L.siPrivacyAff : L.siPrivacyBare
      ]))
